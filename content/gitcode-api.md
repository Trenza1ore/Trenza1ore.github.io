...
linktree:
  ...
  - title: "GitHub Source Code"
    subtitle: "Python SDK · CLI · MCP · Tool"
    url: "https://github.com/Trenza1ore/GitCode-API"
    icon: "github"
  - title: "GitCode Mirror Repo"
    subtitle: "AtomGit / GitCode"
    url: "https://gitcode.com/SushiNinja/GitCode-API"
    icon: "gitcode"
  - title: "Python Package Index (PyPI)"
    subtitle: "pip install -U gitcode-api"
    url: "https://pypi.org/project/gitcode-api/"
    icon: "pypi"
  - title: "MCP Bundle (.mcpb)"
    subtitle: "Latest MCP package for Claude Desktop App"
    url: "gitcode/gitcode-1.2.12.mcpb"
    icon: "claude"
    internal: true
    download: "gitcode-1.2.12.mcpb"
  - title: "GitCode API SKILL (ClawHub)"
    subtitle: "Agent skill for OpenClaw"
